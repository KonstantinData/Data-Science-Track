...
# Simulating a dataset for email spam detection
# In a real-world case, you'd load a dataset such as 'spambase' or similar
np.random.seed(42)
num_samples = 1000
data = pd.DataFrame(
    {
...
"""
In Evaluation we look at following:
Accuracy: Measures how many emails were correctly classified as spam or not spam.
